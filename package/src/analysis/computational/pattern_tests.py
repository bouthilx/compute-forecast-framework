...
from .keywords import COMPUTATIONAL_PATTERNS, validate_patterns
        ...
        for category, test_cases in edge_cases.items():
            ...
            for test_text in test_cases:
                try:
                    ...
                    has_matches = any(len(data.get('raw_matches', [])) > 0 
