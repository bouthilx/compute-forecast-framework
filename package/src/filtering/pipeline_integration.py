...
from .computational_filter import ComputationalResearchFilter, FilteringConfig, FilteringResult
...
class FilteringPipelineIntegration:
    ...
    def __init__(self, filter_config: Optional[FilteringConfig] = None,
                 num_workers: int = 4):
        ...
        logger.info(f"FilteringPipelineIntegration initialized with {num_workers} workers")
    ...
    def filter_papers_realtime(self, papers: List[Paper]) -> List[Paper]:
        ...
        logger.debug(f"Filtered {len(papers)} papers in {filter_time_ms:.1f}ms, "
    ...
    def _update_performance_stats(self, papers_processed: int, papers_passed: int,
        ...
        with self.performance_lock:
            ...
            self.performance_stats['filtered_papers'] += (papers_processed - papers_passed)
    ...
    def create_api_integration(self, api_layer):
        ...
        from ..data.collectors.api_integration_layer import APIIntegrationLayer
    ...
    def create_monitoring_integration(self, monitoring_system):
        ...
        if hasattr(monitoring_system, 'add_metric_collector'):
            monitoring_system.add_metric_collector('computational_filtering', send_metrics, interval=30)
...
def setup_computational_filtering(api_layer, 
                                monitoring_system=None,
                                filter_config: Optional[FilteringConfig] = None) -> FilteringPipelineIntegration:
    """
