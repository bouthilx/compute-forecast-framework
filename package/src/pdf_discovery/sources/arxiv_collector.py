...
class ArXivPDFCollector(BasePDFCollector):
    ...
    def search_by_title_author(self, paper: Paper) -> Optional[str]:
        ...
        first_author = paper.authors[0].name.split(',')[0].strip() if paper.authors else ""
                ...
                if title_elem is not None:
                    ...
                    if self._titles_match(paper_title_lower, entry_title):
                        ...
                        if id_elem is not None:
                            ...
                            if arxiv_id:
                                logger.info(f"Found arXiv match via API search: {arxiv_id}")
                                return arxiv_id
    ...
    def handle_versions(self, arxiv_id: str) -> PDFRecord:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                raise Exception(f"PDF not accessible, status code: {response.status_code}")
