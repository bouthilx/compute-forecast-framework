...
def main():
    ...
    for paper in mila_papers:
        ...
        ml_keywords = ['neural', 'learning', 'deep', 'reinforcement', 'transformer', 
                       'gan', 'vae', 'bert', 'gpt', 'vision', 'nlp', 'machine learning',
                       'artificial intelligence', 'classification', 'detection']
