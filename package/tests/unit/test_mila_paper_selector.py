...
class TestMilaPaperSelector:
        ...
        return [
            {
                ...
                "authors": [{"author": {"name": "John Doe", "links": [{"type": "email.mila"}]}}],
            ...
            },
            {
                ...
                "authors": [{"author": {"name": "Jane Smith", "links": [{"type": "email.mila"}]}}],
            ...
            },
            {
                ...
                "authors": [{"author": {"name": "Bob Johnson", "links": [{"type": "email.mila"}]}}],
            ...
            },
            {
                ...
                "authors": [{"author": {"name": "Alice Brown", "links": [{"type": "email.mila"}]}}],
    ...
    def test_filter_by_year(self, selector, sample_papers):
        ...
        assert len(filtered) == 2
        assert all("2021" in p["releases"][0]["venue"]["date"]["text"] for p in filtered)
