...
from monitoring.intelligent_alerting_system import IntelligentAlertingSystem, create_intelligent_alerting_system
from monitoring.alerting_engine import AlertingEngine, Alert, AlertRule, AlertSeverity, AlertStatus
from monitoring.notification_channels import (
    ConsoleNotificationChannel, DashboardNotificationChannel, create_notification_channel
)
from monitoring.alert_rules import AlertRuleFactory, CustomAlertRule
from monitoring.metrics_collector import MetricsCollector
from monitoring.dashboard_metrics import SystemMetrics, APIMetrics, SystemResourceMetrics
...
class TestAlertRules(unittest.TestCase):
    ...
    def test_default_rule_creation(self):
        ...
        system_rules = [r for r in rule_ids if 'memory' in r or 'cpu' in r or 'disk' in r]
    ...
    def test_api_health_conditions(self):
        ...
        low_success_rule = next((r for r in rules if r.id == "api_success_rate_low"), None)
...
class TestIntelligentAlertingSystem(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        channels = list(self.alerting_system.alerting_engine.notification_channels.keys())
...
class TestIntegrationScenarios(unittest.TestCase):
    ...
    def test_api_health_alert_scenario(self):
        ...
        from monitoring.dashboard_metrics import APIMetrics
        ...
        # Evaluate alerts
        triggered_alerts = self.alerting_system.alerting_engine.evaluate_alerts(metrics_dict)
        
        # Should trigger API success rate alert
        success_rate_alerts = [a for a in triggered_alerts if "success_rate" in a.rule_id]
    ...
    def test_system_resource_alert_scenario(self):
        ...
        from monitoring.dashboard_metrics import SystemResourceMetrics
