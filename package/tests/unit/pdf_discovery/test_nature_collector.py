...
class TestNaturePDFCollector:
    ...
    def test_is_nature_paper_by_venue(self, collector, nature_comms_paper, sci_reports_paper, non_nature_paper):
    ...
    def test_extract_article_id_from_doi(self, collector):
        ...
        assert collector._extract_article_id_from_doi("10.1038/s41467-023-36000-6") == "s41467-023-36000-6"
        
        # Scientific Reports
        assert collector._extract_article_id_from_doi("10.1038/srep12345") == "srep12345"
        
        # Old format
        assert collector._extract_article_id_from_doi("10.1038/ncomms1234") == "ncomms1234"
    ...
    def test_identify_journal(self, collector, nature_comms_paper, sci_reports_paper):
        ...
        assert collector._identify_journal(nature_comms_paper) == "Nature Communications"
    ...
    def test_discover_single_direct_success(self, mock_check, collector, nature_comms_paper):
        """Test successful direct PDF discovery."""
        mock_check.return_value = "https://www.nature.com/articles/s41467-023-36000-6.pdf"
        
        pdf_record = collector._discover_single(nature_comms_paper)
        
        assert pdf_record.paper_id == "test123"
        assert pdf_record.pdf_url == "https://www.nature.com/articles/s41467-023-36000-6.pdf"
    ...
    @patch.object(NaturePDFCollector, '_check_open_access_availability')
    def test_discover_single_fallback_to_doi_resolver(self, mock_check, collector, nature_comms_paper):
        ...
        with patch.object(collector.doi_resolver, '_discover_single', return_value=mock_pdf_record):
            pdf_record = collector._discover_single(nature_comms_paper)
