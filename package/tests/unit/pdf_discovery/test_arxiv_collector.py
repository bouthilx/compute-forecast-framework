...
class TestArXivPDFCollector:
    ...
    @patch('src.pdf_discovery.sources.arxiv_collector.ArXivPDFCollector.handle_versions')
    @patch('src.pdf_discovery.sources.arxiv_collector.ArXivPDFCollector.search_by_title_author')
    @patch('src.pdf_discovery.sources.arxiv_collector.ArXivPDFCollector.extract_arxiv_id')
    def test_discover_single_direct_id(self, mock_extract, mock_search, mock_handle, collector, sample_paper):
    ...
    @patch('src.pdf_discovery.sources.arxiv_collector.ArXivPDFCollector.search_by_title_author')
    @patch('src.pdf_discovery.sources.arxiv_collector.ArXivPDFCollector.extract_arxiv_id')
    def test_discover_single_fallback_search(self, mock_extract, mock_search, mock_handle, collector, sample_paper):
    ...
    @patch('src.pdf_discovery.sources.arxiv_collector.ArXivPDFCollector.search_by_title_author')
    @patch('src.pdf_discovery.sources.arxiv_collector.ArXivPDFCollector.extract_arxiv_id')
    def test_discover_single_no_arxiv_found(self, mock_extract, mock_search, collector, sample_paper):
...
class TestArXivIDExtraction:
    ...
    def test_extract_id_from_url(self):
        ...
        collector = ArXivPDFCollector()
        assert collector._extract_id_from_string("https://arxiv.org/abs/1706.03762") == "1706.03762"
        assert collector._extract_id_from_string("https://arxiv.org/pdf/1706.03762.pdf") == "1706.03762"
        assert collector._extract_id_from_string("http://arxiv.org/abs/1706.03762v3") == "1706.03762"
    
    def test_extract_id_invalid(self):
        """Test behavior with invalid inputs."""
        collector = ArXivPDFCollector()
        assert collector._extract_id_from_string("not-an-arxiv-id") is None
        assert collector._extract_id_from_string("https://example.com/paper.pdf") is None
...
class TestVersionHandling:
    ...
    def test_build_pdf_url(self):
        ...
        collector = ArXivPDFCollector()
        assert collector._build_pdf_url("1706.03762") == "https://arxiv.org/pdf/1706.03762.pdf"
        assert collector._build_pdf_url("2001.12345") == "https://arxiv.org/pdf/2001.12345.pdf"