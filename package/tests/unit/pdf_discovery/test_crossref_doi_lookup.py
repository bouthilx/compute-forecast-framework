...
class TestCrossrefDOILookup:
    ...
    def test_normalize_doi(self, client):
        ...
        assert client.normalize_doi("https://doi.org/10.1038/nature12373") == "10.1038/nature12373"
        assert client.normalize_doi("http://dx.doi.org/10.1038/nature12373") == "10.1038/nature12373"
        assert client.normalize_doi("DOI: 10.1038/nature12373") == "10.1038/nature12373"
