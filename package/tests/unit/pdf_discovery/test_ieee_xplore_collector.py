...
class TestIEEEXplorePDFCollector:
    ...
    def test_initialization(self):
        ...
        assert collector.base_url == "https://ieeexploreapi.ieee.org/api/v1/search/articles"
    ...
    def test_discover_single_with_doi_success(self, mock_get, collector, sample_paper):
        ...
        assert pdf_record.pdf_url == "https://ieeexplore.ieee.org/iel7/123/456/123456.pdf"
    ...
    @patch('requests.get')
    def test_discover_single_title_search_fallback(self, mock_get, collector, sample_paper_no_doi):
        ...
        assert pdf_record.pdf_url == "https://ieeexplore.ieee.org/iel7/789/012/789012.pdf"
    ...
    def test_discover_multiple_papers(self, mock_get, collector, sample_paper):
        ...
        papers = [sample_paper, Mock(spec=Paper, paper_id="test_456", title="Another Paper", doi=None)]
        ...
        assert results["test_paper_123"].pdf_url == "https://ieeexplore.ieee.org/iel7/123/456/123456.pdf"
