...
class TestDashboardAlertingIntegration:
    ...
    def test_full_system_integration(self, mock_metrics):
        ...
        try:
            ...
            dashboard = AdvancedAnalyticsDashboard(host='127.0.0.1', port=5008, debug=False)
    ...
    def test_performance_requirements(self):
        ...
        assert creation_time < 2.0, f"Dashboard creation took {creation_time:.2f}s, should be < 2s"
