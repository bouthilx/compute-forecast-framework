...
class TestFormValidator:
    ...
    def test_validate_consistency(self, form_validator, basic_form_data):
        ...
        assert any("consistency" in msg.lower() or "gpu" in msg.lower() for msg in all_messages)
...
class TestFormManager:
    ...
    def test_save_and_load_form(self, form_manager, basic_form_data, temp_dir):
        ...
        # Save form
        filepath = form_manager.save_form(basic_form_data, "test_001", forms_dir=temp_dir)
        assert filepath.exists()
    ...
    def test_convert_extraction_result_to_form(self, form_manager, sample_extraction_result):
