...
class TestMockDataGenerator:
    ...
    def test_generate_edge_case_papers(self):
        ...
        for paper in papers:
            ...
            if paper.citation_velocity is not None and (
                paper.citation_velocity == 0.0 or 
                paper.citation_velocity > 50.0
            ):
    ...
    def test_validate_output(self):
        ...
        assert generator.validate_output(papers, edge_config) is True  # Normal papers pass edge validation
        
        # Test validation with CORRUPTED quality - normal papers should fail
        corrupted_config = MockDataConfig(quality=DataQuality.CORRUPTED, size=10, seed=42)
        assert generator.validate_output(papers, corrupted_config) is False  # Too many fields populated
    ...
    def test_authorship_analysis_generation(self):
        ...
        for paper in papers_with_auth:
            ...
            assert auth.category in ["academic_eligible", "industry_eligible", "needs_manual_review"]
