...
class TestBreakthroughDetector:
    ...
    def test_load_breakthrough_keywords_from_file(self):
        ...
        with patch('src.data.processors.breakthrough_detector.Path.exists', return_value=True):
    ...
    def test_calculate_breakthrough_score_high_impact(self, detector, high_impact_paper):
    ...
    def test_calculate_breakthrough_score_medium_impact(self, detector, medium_impact_paper):
    ...
    def test_detect_breakthrough_papers(self, detector, high_impact_paper, medium_impact_paper, low_impact_paper):
        ...
        with patch('src.data.processors.breakthrough_detector.datetime') as mock_datetime:
            ...
            if len(breakthrough_papers) > 1:
                for i in range(len(breakthrough_papers) - 1):
                    assert breakthrough_papers[i].breakthrough_score >= breakthrough_papers[i + 1].breakthrough_score
    ...
    def test_author_reputation_with_h_index(self, detector):
        ...
        score, high_impact_authors = detector._calculate_author_reputation_score(authors)
    ...
    def test_breakthrough_paper_dataclass(self, detector, high_impact_paper):
        ...
        with patch('src.data.processors.breakthrough_detector.datetime') as mock_datetime:
            ...
            breakthrough_papers = detector.detect_breakthrough_papers([high_impact_paper])
