...
class TestCitationAnalyzerEdgeCases:
    ...
    def test_empty_venue_analysis(self):
        ...
        assert report.venue_analysis["UnknownVenue"].venue_tier == "tier4"  # Default tier
    ...
    def test_filtering_with_all_papers_below_threshold(self):
        ...
        result = self.analyzer.filter_papers_by_citations(papers, preserve_breakthroughs=False)
    ...
    def test_validate_filtering_quality_extreme_cases(self):
        ...
        quality_report = self.analyzer.validate_filtering_quality(all_papers, filtered_papers)
        assert len(quality_report.warnings) > 0  # Should have warnings about aggressive filtering
