...
class TestAdaptiveThresholdCalculator:
    ...
    def test_calculate_venue_threshold_no_citations(self, calculator):
        ...
        papers = [
            Paper(paper_id=str(i), title=f"Paper {i}", venue="Venue", year=2023, citations=None, authors=[Author(name="Test")])
            for i in range(5)
        ]
    ...
    def test_calculate_adaptive_threshold_comprehensive(self, calculator, sample_papers):
    ...
    def test_minimum_threshold(self, calculator):
        ...
        papers = [
            ...
            Paper(paper_id="3", title="P3", venue="Venue", year=2023, citations=0, authors=[Author(name="Test")])
        ]
    ...
    def test_years_capping(self, calculator):
        ...
        with patch('src.data.processors.adaptive_threshold_calculator.datetime') as mock_datetime:
            ...
            old_papers = [
                Paper(paper_id="1", title="Old", venue="NeurIPS", year=2014, citations=100, authors=[Author(name="Test")])
            ]
