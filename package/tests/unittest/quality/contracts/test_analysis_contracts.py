...
class TestComputationalAnalysisContract:
    ...
    def test_validate_missing_fields(self, contract):
        ...
        missing_fields = {v.field_name for v in violations if v.violation_type == ContractViolationType.MISSING_REQUIRED_FIELD}
    ...
    def test_validate_richness_out_of_range(self, contract):
        ...
        range_violations = [v for v in violations if v.violation_type == ContractViolationType.OUT_OF_RANGE]
    ...
    def test_validate_low_confidence_warning(self, contract):
        ...
        assert warnings[0].violation_type == ContractViolationType.BUSINESS_RULE_VIOLATION
    ...
    def test_validate_invalid_keyword_matches(self, contract):
        ...
        type_violations = [v for v in violations if v.violation_type == ContractViolationType.INVALID_TYPE]
    ...
    def test_validate_negative_keyword_count(self, contract):
        ...
        keyword_violations = [v for v in violations if "keyword_matches" in v.field_name]
    ...
    def test_validate_gpu_inconsistency(self, contract):
        ...
        gpu_warnings = [v for v in violations if v.field_name == "resource_metrics.gpu_type" and v.severity == "warning"]
    ...
    def test_validate_negative_resource_metrics(self, contract):
        ...
        negative_violations = [v for v in violations if v.violation_type == ContractViolationType.OUT_OF_RANGE and "resource_metrics" in v.field_name]
...
class TestPaperMetadataContract:
    ...
    def test_validate_missing_title(self, contract):
        ...
        missing_violations = [v for v in violations if v.violation_type == ContractViolationType.MISSING_REQUIRED_FIELD]
    ...
    def test_validate_empty_title(self, contract):
        ...
        assert title_violations[0].violation_type == ContractViolationType.BUSINESS_RULE_VIOLATION
    ...
    def test_validate_empty_authors(self, contract):
        ...
        assert author_violations[0].violation_type == ContractViolationType.BUSINESS_RULE_VIOLATION
    ...
    def test_validate_negative_citations(self, contract):
        ...
        assert citation_violations[0].violation_type == ContractViolationType.OUT_OF_RANGE
    ...
    def test_validate_no_identifiers(self, contract):
        ...
        assert id_violations[0].violation_type == ContractViolationType.BUSINESS_RULE_VIOLATION
...
class TestResourceMetricsContract:
    ...
    def test_validate_too_many_metrics(self, contract):
        ...
        perf_violations = [v for v in violations if v.violation_type == ContractViolationType.PERFORMANCE_VIOLATION]
    ...
    def test_validate_empty_metric_key(self, contract):
        ...
        key_violations = [v for v in violations if v.violation_type == ContractViolationType.INVALID_TYPE and "non-empty string" in v.message]
    ...
    def test_validate_negative_gpu_count(self, contract):
        ...
        gpu_violations = [v for v in violations if "gpu" in v.field_name.lower() and v.violation_type == ContractViolationType.OUT_OF_RANGE]
    ...
    def test_validate_negative_time_values(self, contract):
        ...
        time_violations = [v for v in violations if v.violation_type == ContractViolationType.OUT_OF_RANGE]
    ...
    def test_validate_negative_size_values(self, contract):
        ...
        size_violations = [v for v in violations if v.violation_type == ContractViolationType.OUT_OF_RANGE]
