...
from src.quality.extraction.extraction_validator import (
...
class TestExtractionQualityValidator:
    ...
    def setup_method(self):
        ...
        self.minimal_extraction = ComputationalAnalysis(
            gpu_hours=10
        )
    
    def test_validate_complete_extraction(self):
        """Test validation of complete extraction."""
        result = self.validator.validate_extraction(self.paper, self.complete_extraction)
    ...
    def test_paper_consistency_check(self):
        ...
        lm_extraction = ComputationalAnalysis(
            parameters=10e9,
            gpu_hours=50000
        )
        ...
        cv_extraction = ComputationalAnalysis(
            batch_size=128,
            parameters=50e6
        )
