...
class TestExtractionIntegration:
    ...
    def mock_analyzer_nlp_result(self):
        ...
        return {
            ...
            'keyword_matches': {
                ...
                'ml_terms': {'score': 10, 'keywords': ['transformer', 'BERT', 'attention']}
            },
            'resource_metrics': {
                'gpu_type': 'TPU v3',
                'tpu_cores': 16,
    ...
    def test_nlp_extraction_workflow(self, mock_analyzer_class, sample_paper_nlp, mock_analyzer_nlp_result):
        ...
        assert fields[ExtractionField.PARAMETERS_COUNT] == 340.0  # Normalized to millions
    ...
    @patch('src.extraction.template_engine.ComputationalAnalyzer')
    def test_cv_extraction_workflow(self, mock_analyzer_class, sample_paper_cv, mock_analyzer_cv_result):
    ...
    def test_custom_template_registration(self):
        ...
        custom_template = ExtractionTemplate(
            ...
            validation_rules={
                ExtractionField.GPU_COUNT: {"min": 1, "max": 100}
            },
            normalization_rules={}
        )
