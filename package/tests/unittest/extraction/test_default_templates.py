...
class TestDefaultTemplates:
    ...
    def test_nlp_training_template(self):
        ...
        assert template.normalization_rules[ExtractionField.PARAMETERS_COUNT] == "convert_to_millions"
    ...
    def test_cv_training_template(self):
        ...
        assert ExtractionField.GPU_MEMORY_GB in required or ExtractionField.GPU_MEMORY_GB in template.optional_fields
