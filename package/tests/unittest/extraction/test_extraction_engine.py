...
from src.extraction.template_engine import (
    ExtractionTemplateEngine, ExtractionTemplate, ExtractionField
)
...
class TestExtractionTemplateEngine:
    ...
    def test_extract_to_template(self, mock_analyzer_class, sample_template, mock_analyzer_result):
    ...
    @patch('src.extraction.template_engine.ComputationalAnalyzer')
    def test_map_to_template(self, mock_analyzer_class, sample_template, mock_analyzer_result):
    ...
    @patch('src.extraction.template_engine.ComputationalAnalyzer')
    def test_confidence_scores(self, mock_analyzer_class, sample_template, mock_analyzer_result):
