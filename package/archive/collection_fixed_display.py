...
DOMAINS = {
    ...
    "Natural Language Processing": [
        "natural language processing", "NLP", "language model", "text analysis"
    ],
    "Reinforcement Learning & Robotics": [
        "reinforcement learning", "robotics", "RL", "policy gradient"
    ]
}
...
def create_layout(tracker):
    ...
    log_text = Text("\\n".join(recent_lines[-20:]) if recent_lines else "Dashboard ready - waiting for collection to start...")
...
def main():
    ...
    console = Console()
    console.print("🚀 Starting FIXED Real-Time Paper Collection Dashboard", style="bold green")
    console.print("🎯 This version should show live updates properly!", style="bold blue")
    console.print()
