...
def main():
    ...
    for domain_idx, domain in enumerate(domains):
        ...
        for year in range(2019, 2025):
            ...
            try:
                year_papers = domain_collector.collect_domain_year_papers(domain, year, target_count=4)
                ...
                if year % 2 == 0:
                    ...
                    save_progress(all_papers, all_domain_stats, f"progress_{domain_idx}_{year}.json")
        ...
        final_domain_papers = [p for p in domain_papers if p not in all_papers]  # Avoid duplicates
        ...
        save_progress(all_papers, all_domain_stats, f"domain_progress_{domain_idx}.json")
    ...
    if len(all_papers) >= 8:
        ...
        print(f"  - data/simple_collected_papers.json (8 papers - proof of concept)")
