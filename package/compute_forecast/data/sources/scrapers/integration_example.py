...
class EnhancedScaper(BaseScaper):
    ...
    def __init__(self, source_name: str, config: ScrapingConfig = None):
        ...
        self.rate_limiter = RateLimiter(requests_per_second=1.0 / self.config.rate_limit_delay)
    ...
    def get_monitoring_report(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "recent_errors": [str(error) for error in self.monitor.get_recent_errors(5)],
...
def demonstration_workflow():
    ...
    print("\nRate limiter state:")
    print(f"  Consecutive errors: {monitoring_report['rate_limiter_state']['consecutive_errors']}")
    print(f"  Current delay: {monitoring_report['rate_limiter_state']['current_delay']:.2f}s")
