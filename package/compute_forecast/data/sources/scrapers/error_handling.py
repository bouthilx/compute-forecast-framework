...
class ScrapingMonitor:
    ...
    def record_success(self, papers_count: int, venue: str, year: int):
        ...
        self.logger.info(f"Successfully scraped {papers_count} papers from {venue} {year}")
...
class RateLimiter:
    ...
    def wait(self):
        ...
        if self.consecutive_errors > 0:
            backoff_multiplier = min(2 ** self.consecutive_errors, self.max_backoff_multiplier)
