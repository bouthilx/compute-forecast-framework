...
class AffiliationParser:
    ...
    def __init__(self):
        ...
        self.academic_keywords = [
            ...
            'dept', 'lab', 'center for', 'centre for'
        ]
        
        self.industry_keywords = [
            'corporation', 'inc.', 'ltd.', 'llc', 'labs', 
            'research lab', 'ai lab', 'technologies', 'corp',
    ...
    def normalize_affiliation(self, raw_affiliation: str) -> str:
        ...
        normalized = re.sub(r'\b\d+\s+(st|nd|rd|th)\b', '', normalized)  # street numbers
    ...
    def extract_primary_institution(self, affiliation: str) -> str:
        ...
        if parts:
            ...
            primary = re.sub(r'^(department of|faculty of|school of|center for|centre for)\s+', '', primary)
    ...
    def classify_affiliation(self, affiliation: str) -> Dict[str, any]:
        ...
        academic_score = self._calculate_keyword_score(normalized, self.academic_keywords)
        industry_score = self._calculate_keyword_score(normalized, self.industry_keywords)
