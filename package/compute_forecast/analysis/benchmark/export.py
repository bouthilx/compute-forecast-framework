...
from compute_forecast.analysis.benchmark.models import ExtractionBatch, BenchmarkExport
...
class BenchmarkCSVExporter:
    ...
    def __init__(self):
        self.csv_headers = [
            "paper_id", "title", "year", "domain", "venue",
            "gpu_hours", "gpu_type", "gpu_count", "training_days",
            "parameters_millions", "dataset_size_gb", "extraction_confidence",
            "is_sota", "benchmark_datasets"
        ]
    
    def export_batches_to_csv(self, batches: List[ExtractionBatch], output_path: str) -> None:
    ...
    def _paper_to_export(self, benchmark_paper) -> BenchmarkExport:
        ...
        return BenchmarkExport(
            ...
            parameters_millions=resource_metrics.get("parameters", 0) / 1_000_000 if resource_metrics.get("parameters") else None,
