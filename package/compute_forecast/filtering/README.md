...
```python
from compute_forecast.filtering import ComputationalResearchFilter, FilteringConfig
...
```python
from compute_forecast.filtering import setup_computational_filtering
