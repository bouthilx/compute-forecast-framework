...
class DataCorruptionScenarios:
    ...
    def get_paper_corruption_scenario() -> List[ErrorScenario]:
        ...
        return [
            ...
            ErrorScenario(
                ...
                metadata={
                    "format_issues": ["invalid_json", "encoding_errors"]
                }
            )
        ]
        ...
        for i in range(5):
            ...
            scenarios.append(
                ErrorScenario(
                    ...
                    metadata={
                        "stage": i + 1,
                        "corruption_level": f"{probability:.0%}"
                    }
                )
            )
    ...
    def validate_data_integrity(recovery_metrics: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if data_preserved < 0.95:  # 95% threshold
            ...
            validation["checks"].append(f"Data preservation rate {data_preserved:.1%} meets requirement")
