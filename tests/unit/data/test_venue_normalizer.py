...
class TestFuzzyVenueMatcher:
    ...
    def test_normalize_venue_name(self):
        ...
        assert (
            self.matcher.normalize_venue_name("NeurIPS'23")
        ...
        assert (
            "NEURAL INFORMATION PROCESSING SYSTEMS"
            in self.matcher.normalize_venue_name("NIPS")
        )
...
class TestVenueMappingLoader:
    ...
    def test_load_venues_yaml(self):
        ...
        venues_yaml_data = {
            ...
            "computational_focus_scores": {"ICML": 0.95, "NeurIPS": 0.95},
        }
...
class TestVenueNormalizer:
    ...
    def test_normalize_venue_fuzzy_match(self):
        ...
        result = self.normalizer.normalize_venue(
    ...
    def test_normalize_venue_no_match(self):
        ...
        assert (
            result.normalized_venue == "Completely Unknown Conference"
        )  # Keep original
...
class TestIntegration:
    ...
    def test_end_to_end_normalization(self):
        ...
        required_files = ["worker6_venue_mapping.json", "config/venues.yaml"]
