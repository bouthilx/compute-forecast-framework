...
class TestACLAnthologyScraper:
    ...
    def test_extract_paper_from_entry(self):
        ...
        paper = self.scraper._extract_paper_from_entry(
            entry, "ACL", 2024, "https://test.com"
        )
    ...
    def test_extract_pdf_url_patterns(self):
        ...
        pdf_url1 = self.scraper._extract_pdf_url(
            entry1, "https://aclanthology.org/2024.acl-long.0/"
        )
        ...
        pdf_url2 = self.scraper._extract_pdf_url(
            entry2, "https://aclanthology.org/P24-1234/"
        )
        ...
        pdf_url3 = self.scraper._extract_pdf_url(
            entry3, "https://aclanthology.org/2024.acl-long.0/"
        )
        ...
        pdf_url4 = self.scraper._extract_pdf_url(
            entry4, "https://aclanthology.org/2024.acl-short.15/"
        )
