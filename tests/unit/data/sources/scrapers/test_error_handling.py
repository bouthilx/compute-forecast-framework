...
class TestScrapingMonitor:
    ...
    def test_logging_integration(self, mock_get_logger):
        ...
        mock_logger.info.assert_called_with("Successfully scraped 10 papers from CVPR 2023")
...
class TestIntegration:
    ...
    def test_full_error_handling_workflow(self):
        ...
        assert limiter.consecutive_errors == 2  # From the failed call (original + 1 retry)
