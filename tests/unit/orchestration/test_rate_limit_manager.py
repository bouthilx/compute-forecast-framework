...
from compute_forecast.data.models import APIConfig, APIHealthStatus, RollingWindow
...
class TestRateLimitManager:
    ...
    def test_can_make_request_basic_functionality(self):
        ...
        assert (
            self.rate_limiter.can_make_request("semantic_scholar", request_size=5)
            is True
        )
        ...
        assert (
            self.rate_limiter.can_make_request("semantic_scholar", request_size=10)
            is False
        )
