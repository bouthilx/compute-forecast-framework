...
class TestOpenReviewAdapter:
    ...
    def test_venue_id_mapping(self, adapter):
        ...
        assert adapter._get_venue_id("rlc", 2024) == "rl-conference.cc/RLC/2024/Conference"
    ...
    def test_conference_scraping(self, mock_get_submissions_v1, mock_get_submissions, mock_get_scraper, adapter):
    ...
    def test_conference_submission_formats(self, adapter):
        ...
        submissions = adapter._get_conference_submissions("test.venue/2024/Conference", "colm")
    ...
    def test_scrape_venue_year_error_handling(self, adapter):
        ...
        with patch.object(adapter, '_get_paperoni_scraper', side_effect=Exception("API Error")):
            result = adapter.scrape_venue_year("ICLR", 2023)
