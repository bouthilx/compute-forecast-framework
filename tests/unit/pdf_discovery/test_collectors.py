...
class TestBasePDFCollector:
    ...
    def test_discover_pdfs_with_failures(self):
        ...
        collector = MockPDFCollector()
        papers = [
            Paper(paper_id="paper_1", title="Success 1", authors=[], year=2024,
                  citations=0, venue="Test"),
            Paper(paper_id="fail_paper", title="Fail", authors=[], year=2024,
                  citations=0, venue="Test"),
            Paper(paper_id="paper_2", title="Success 2", authors=[], year=2024,
                  citations=0, venue="Test"),
        ]
    ...
    def test_discover_pdfs_with_timeout(self):
        ...
        papers = [
            Paper(paper_id="paper_1", title="Test", authors=[], year=2024,
                  citations=0, venue="Test")
        ]
    ...
    def test_collector_statistics_tracking(self):
        ...
        # After discovery
        papers = [
            Paper(paper_id="paper_1", title="Success", authors=[], year=2024,
                  citations=0, venue="Test"),
            Paper(paper_id="fail_paper", title="Fail", authors=[], year=2024,
                  citations=0, venue="Test"),
        ]
    ...
    def test_batch_discovery(self):
        ...
        collector.discover_pdfs_batch = batch_discover.__get__(collector, MockPDFCollector)
        
        papers = [
            Paper(paper_id=f"paper_{i}", title=f"Test {i}", authors=[], year=2024,
                  citations=0, venue="Test")
            for i in range(10)
        ]
