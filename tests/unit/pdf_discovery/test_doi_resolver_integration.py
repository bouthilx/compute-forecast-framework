...
class TestDOIResolverIntegration:
    ...
    def test_rate_limiting_configuration(self):
        ...
        assert collector.crossref_client.retry_delay == 2.0  # CrossRef prefers slower requests
        assert collector.unpaywall_client.retry_delay == 1.0  # Unpaywall is more lenient