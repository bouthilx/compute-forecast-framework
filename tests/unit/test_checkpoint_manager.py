...
class TestCheckpointManager:
    ...
    def test_create_checkpoint_with_error_context(self, checkpoint_manager):
        ...
        loaded_checkpoint = checkpoint_manager.load_checkpoint(session_id, checkpoint_id)
    ...
    def test_load_nonexistent_checkpoint(self, checkpoint_manager):
        ...
        loaded_checkpoint = checkpoint_manager.load_checkpoint(session_id, fake_checkpoint_id)
    ...
    def test_validate_checkpoint(self, checkpoint_manager):
        ...
        validation_result = checkpoint_manager.validate_checkpoint(session_id, checkpoint_id)
    ...
    def test_validate_nonexistent_checkpoint(self, checkpoint_manager):
        ...
        validation_result = checkpoint_manager.validate_checkpoint(session_id, fake_checkpoint_id)
    ...
    def test_cleanup_session_checkpoints(self, checkpoint_manager):
        ...
        cleaned_count = checkpoint_manager.cleanup_session_checkpoints(session_id, keep_latest=3)
    ...
    def test_validate_session_checkpoints(self, checkpoint_manager):
        ...
        assert all(result.validation_type == "checkpoint_integrity" for result in validation_results)
        assert all(result.passed for result in validation_results)  # All should be valid
