...
class TestEndToEndTestFramework:
    ...
    def test_register_phase_validator(self, framework):
        ...
        framework.register_phase_validator(PipelinePhase.COLLECTION, mock_validator)
    ...
    def test_run_pipeline_basic(self, framework):
        ...
        # Create test data
        test_papers = [Mock(spec=Paper, paper_id=f"paper_{i}") for i in range(10)]
    ...
    def test_validate_phase_transition(self, framework):
        ...
        assert (
            framework.validate_phase_transition(
    ...
    def test_execution_time_limits(self, framework):
        ...
        framework.register_phase_validator(PipelinePhase.COLLECTION, slow_validator)
