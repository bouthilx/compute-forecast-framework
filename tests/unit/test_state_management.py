...
class TestStateManager:
    ...
    def test_create_session_with_custom_id(self, state_manager, sample_venues, sample_config):
    ...
    def test_create_session_duplicate_id(self, state_manager, sample_venues, sample_config):
    ...
    def test_performance_requirements(self, state_manager, sample_venues, sample_config):
    ...
    def test_session_validation(self, state_manager, sample_venues, sample_config):
        ...
        assert all(isinstance(result.confidence, float) for result in validation_results)
