...
class TestCOREHALIntegration:
    ...
    def test_framework_integration_with_core_and_hal(self, framework, sample_papers):
        ...
        with patch('requests.get') as mock_get:
            ...
            assert result.discovered_count >= 1  # At least paper1 from CORE should be found
            ...
            assert paper1_records[0].pdf_url == "https://core.ac.uk/download/pdf/100001.pdf"
                    ...
                    if '/search' in url:
                        ...
                        mock_resp.json.return_value = {
                            "response": {
                                ...
                                "docs": [{
                                    "docid": "hal-99999999",
                                    "files_s": ["https://hal.science/hal-99999999/file/paper.pdf"],
