...
class TestACLAnthologyIntegration:
    ...
    def test_framework_integration(self, framework, sample_papers):
        ...
        with patch.object(collector, '_discover_single', side_effect=mock_discover_single):
            # Run discovery
    ...
    def test_real_url_construction(self):
        ...
        test_cases = [
            ("emnlp-main", 2023, "456", "https://aclanthology.org/2023.emnlp-main.456.pdf"),
            ("acl-long", 2022, "123", "https://aclanthology.org/2022.acl-long.123.pdf"),
            ("naacl-short", 2021, "789", "https://aclanthology.org/2021.naacl-short.789.pdf"),
            ("eacl-main", 2020, "001", "https://aclanthology.org/2020.eacl-main.001.pdf"),
        ]
