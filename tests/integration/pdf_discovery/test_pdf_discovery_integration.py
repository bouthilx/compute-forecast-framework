...
class TestPDFDiscoveryIntegration:
    ...
    def test_venue_based_routing(self):
        ...
        papers = [
            Paper(paper_id="iclr_1", title="ICLR Paper", authors=[], 
                  year=2024, citations=10, venue="ICLR"),
            Paper(paper_id="acl_1", title="ACL Paper", authors=[], 
                  year=2024, citations=5, venue="ACL", arxiv_id="2401.11111"),
        ]
    ...
    def test_failure_resilience(self):
        ...
        papers = [
            Paper(paper_id=f"paper_{i}", title=f"Paper {i}", authors=[], 
                  year=2024, citations=i, venue="Test")
            for i in range(5)
        ]
