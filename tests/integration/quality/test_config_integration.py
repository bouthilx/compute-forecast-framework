...
class TestConfigIntegration:
    ...
    def test_custom_config_creation(self):
        ...
        custom_thresholds = {"min_completeness": 0.9, "min_coverage": 0.85}
    ...
    def test_config_validation(self):
        ...
        with pytest.raises(ValidationError):
            create_quality_config(stage="collection", output_format="invalid_format")
    ...
    def test_post_command_hook_with_custom_config(self):
        ...
        with TemporaryDirectory() as tmp_dir:
            ...
            custom_config = create_quality_config(
                stage="collection", thresholds={"min_completeness": 0.9}, verbose=True
            )
    ...
    def test_config_usage_in_quality_command(self):
        ...
        config = create_quality_config(
            stage=stage,
            thresholds={"min_completeness": min_completeness}
            if min_completeness
            else None,
