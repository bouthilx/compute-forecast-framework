...
class TestConsistencyChecker:
    ...
    def test_batch_size_consistency(self):
        ...
        data = {
            ...
            "hardware": {"gpu_count": 8, "gpu_memory_gb": 16.0},
    ...
    def test_training_time_consistency(self):
        ...
        data = {
            "training": {"total_time_hours": 120.0, "epochs": 100, "batch_size": 64},
            "dataset": {
...
class TestConfidenceAssessor:
    ...
    def test_assess_field_confidence(self):
        ...
        field_data = {"gpu_type": "V100", "gpu_count": 8, "gpu_memory_gb": 16.0}
...
class TestDataIntegrityChecker:
    ...
    def test_check_format_consistency(self, sample_extraction_data):
        ...
        sample_extraction_data["metadata"]["extraction_date"] = (
...
class TestCrossFieldValidator:
    ...
    def test_validate_gpu_memory_consistency(self):
        ...
        data = {"hardware": {"gpu_type": "V100", "gpu_memory_gb": 16.0}}
...
class TestStatisticalValidator:
    ...
    def test_calculate_z_scores(self):
        ...
        z_score = validator.calculate_z_score(
            300, validator.reference_data["parameter_counts"]
        )
        assert abs(z_score) < 2.0

        # Test outlier value
        z_score = validator.calculate_z_score(
            10000, validator.reference_data["parameter_counts"]
        )
        assert abs(z_score) > 2.0
...
class TestQualityController:
    ...
    def test_validate_extraction_data(self, quality_controller, sample_extraction_data):
        ...
        validation_results = quality_controller.validate_extraction_data(
    ...
    def test_check_consistency(self, quality_controller, sample_extraction_data):
        ...
        consistency_issues = quality_controller.check_consistency(
            sample_extraction_data
        )
...
class TestQualityDashboard:
    ...
    def test_get_quality_trends(self):
        ...
        assert (
            trends["overall_score"][-1] > trends["overall_score"][0]
        )  # Improving trend
