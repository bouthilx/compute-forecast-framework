...
def create_final_visualizations():
    ...
    ax1.set_title(
        "Paper Classification Proportions Over Time (COMPLETE DATA)",
        fontsize=14,
        fontweight="bold",
    )
    ax1.set_xlabel("Year")
    ...
    ax2.set_title(
        "Paper Classification Counts Over Time (COMPLETE DATA)",
        fontsize=14,
        fontweight="bold",
    )
    ax2.set_xlabel("Year")
...
def create_research_domains_focus_complete():
    ...
    ax1.set_title(
        "Research Domain Proportions Over Time (COMPLETE DATA)\n(Excluding unclassified papers)",
        fontsize=14,
        fontweight="bold",
    )
    ...
    ax2.set_title(
        "Research Domain Counts Over Time (COMPLETE DATA)",
        fontsize=14,
        fontweight="bold",
    )
    ax2.set_xlabel("Year")
    ...
    plt.tight_layout()
    plt.savefig(
        "research_domains_temporal_analysis_COMPLETE.png", dpi=300, bbox_inches="tight"
    )
    plt.show()
...
def main():
    ...
    print("- paper_classification_temporal_analysis_COMPLETE.png")
    print("- research_domains_temporal_analysis_COMPLETE.png")
    print("- temporal_analysis_data_COMPLETE.json")
