...
def main():
    ...
    parser.add_argument(
        "--papers-per-year-min", type=int, default=15, help="Minimum papers per year"
    )
    parser.add_argument(
        "--papers-per-year-max", type=int, default=30, help="Maximum papers per year"
    )
    parser.add_argument(
        "--min-richness",
        type=float,
    ...
    print(
        f"    Range: [{summary['computational_richness']['min']:.3f}, {summary['computational_richness']['max']:.3f}]"
    )
