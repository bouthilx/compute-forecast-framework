...
"""
        ...
        test_file_metadata = {"name": "test.txt", "parents": [folder["id"]]}

        test_file = (
            service.files().create(body=test_file_metadata, fields="id").execute()
        )
...
if __name__ == "__main__":
    ...
    if folder_id:
        print("\nNext steps:")
        print("1. The folder is ready to use")
        print("2. Run your PDF discovery/storage scripts")
        print("3. PDFs will be stored in the service account's Drive")
