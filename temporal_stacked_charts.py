...
def create_stacked_area_charts():
    ...
    ax1.set_title('Paper Classification Proportions Over Time', fontsize=14, fontweight='bold')
    ax1.set_xlabel('Year')
    ...
    ax2.set_title('Paper Classification Counts Over Time', fontsize=14, fontweight='bold')
    ax2.set_xlabel('Year')
    ...
    plt.tight_layout()
    plt.savefig('paper_classification_temporal_analysis.png', dpi=300, bbox_inches='tight')
    plt.show()
...
def main():
    ...
    # Create main charts
    years, categories, year_data, data_matrix, prop_matrix = create_stacked_area_charts()
    ...
    print(f"\nCharts saved as:")
    print(f"- paper_classification_temporal_analysis.png")
    print(f"- research_domains_temporal_analysis.png") 
    print(f"- temporal_analysis_data.json")
