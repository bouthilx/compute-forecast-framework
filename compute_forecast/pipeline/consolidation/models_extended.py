...
class ConsolidationPhaseState:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'identifiers_collected': {k: v.to_dict() for k, v in self.identifiers_collected.items()},
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'ConsolidationPhaseState':
        ...
        state = cls(
            ...
            phase_start_time=datetime.fromisoformat(data['phase_start_time']) if data.get('phase_start_time') else None,
            phase_end_time=datetime.fromisoformat(data['phase_end_time']) if data.get('phase_end_time') else None,
