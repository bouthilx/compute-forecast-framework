...
from ...metadata_collection.models import VenueAnalysis
...
class VenueRelevanceScorer:
    ...
    def __init__(self):
        ...
        logger.info(
            "VenueRelevanceScorer initialized with comprehensive venue database"
        )

    def score_venue(
        self, venue_name: str, paper_count: Optional[int] = None
    ) -> VenueAnalysis:
        """
    ...
    def _get_importance_ranking(self, venue_name: str) -> int:
        ...
        if any(
            term in venue_upper for term in ["INTERNATIONAL", "CONFERENCE", "SYMPOSIUM"]
        ):
    ...
    def _calculate_venue_score(
        ...
        venue_score = (
            domain_relevance * 0.4 + computational_focus * 0.3 + importance_score * 0.3
        )
