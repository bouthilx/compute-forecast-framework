...
class NormalizationEngine:
    ...
    def __init__(self):
        ...
        self.memory_conversions = {"MB": 1 / 1024, "GB": 1, "TB": 1024}

        self.parameter_conversions = {"K": 1e-3, "M": 1, "B": 1e3, "T": 1e6}
    ...
    def normalize_field_value(self, field: ExtractionField, value: Any) -> Any:
        ...
        if field == ExtractionField.PARAMETERS_COUNT:
            ...
            if (
                num_val < 1000
            ):  # Already in millions (or billions converted to millions)
                return num_val
