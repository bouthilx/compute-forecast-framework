...
def test_initialization():
    ...
    try:
        ...
        print("   ✅ GoogleScholarSource created successfully")
        ...
        print(
            f"   Chrome driver: {'✅ Available' if chrome_available else '❌ Missing'}"
        )
        print(
            f"   Firefox driver: {'✅ Available' if firefox_available else '❌ Missing'}"
        )
        ...
        if scholar.use_browser:
            ...
            if setup_method:
                print("   ✅ Browser setup method available")
            else:
                print("   ❌ Browser setup method missing")
