...
class VenueCollectionOrchestrator:
    ...
    def _initialize_agent_alpha(self) -> ComponentStatus:
        ...
        try:
            ...
            from ...pipeline.metadata_collection.collectors.api_integration_layer import (
                VenueCollectionEngine,
            )
            from ...monitoring.server.health_monitor import HealthMonitor
            from ...monitoring.server.rate_limiter import AdaptiveRateLimiter
    ...
    def _initialize_agent_beta(self) -> ComponentStatus:
        ...
        try:
            ...
            self.state_manager = StatePersistenceManager(
                state_dir=Path(getattr(self.config, "checkpoint_dir", "./checkpoints"))
            )
    ...
    def _initialize_agent_gamma(self) -> ComponentStatus:
        ...
        try:
            ...
            from ...pipeline.metadata_collection.processors.venue_normalizer import (
                VenueNormalizer,
            )
            from ...pipeline.paper_filtering.selectors.citation_filter import (
                CitationFilter,
            )
    ...
    def _initialize_agent_delta(self) -> ComponentStatus:
        ...
        try:
            ...
            from ...monitoring.server.dashboard_server import CollectionDashboard
            from ...monitoring.alerting.alert_system import AlertSystemFactory
