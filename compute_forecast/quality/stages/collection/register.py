...
from .formatter_adapters import (
    CollectionTextFormatterAdapter,
    CollectionJSONFormatterAdapter,
    CollectionMarkdownFormatterAdapter,
)
...
def register_collection_formatters():
    ...
    FormatterRegistry.register(
        "text", CollectionTextFormatterAdapter, stage="collection"
    )
    FormatterRegistry.register(
        "json", CollectionJSONFormatterAdapter, stage="collection"
    )
    FormatterRegistry.register(
        "markdown", CollectionMarkdownFormatterAdapter, stage="collection"
    )
