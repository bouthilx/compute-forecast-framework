...
from compute_forecast.quality.core.formatters import ReportFormatter
...
class CollectionFormatterAdapter(ReportFormatter):
    ...
    def _create_metrics_from_report(
        ...
        return CollectionQualityMetrics(
            ...
            papers_with_all_required_fields=metrics_data.get(
                "papers_with_all_required_fields", 0
            ),
