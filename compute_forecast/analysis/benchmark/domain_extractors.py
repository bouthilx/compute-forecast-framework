...
class NLPBenchmarkExtractor:
    ...
    def __init__(self):
        self.benchmark_datasets = [
            "GLUE", "SuperGLUE", "SQuAD", "WMT", "CommonCrawl",
            "BERT", "RoBERTa", "GPT", "T5", "MMLU", "HellaSwag",
            "ARC", "BoolQ", "CoQA", "RACE", "SWAG", "Winograd",
        ]
    ...
    def identify_benchmarks(self, paper: Paper) -> List[str]:
        ...
        for dataset in self.benchmark_datasets:
            ...
            if dataset in ["BERT", "GPT", "T5"] and dataset.lower() in text:
                ...
                if re.search(f"evaluated?\\s+on\\s+.*{dataset.lower()}", text) or \
                   re.search(f"{dataset.lower()}\\s+benchmark", text):
...
class CVBenchmarkExtractor:
    ...
    def __init__(self):
        self.benchmark_datasets = [
            ...
            "ADE20K", "Kinetics", "Pascal VOC", "CityScapes",
            "Open Images", "KITTI", "ModelNet", "ShapeNet",
        ]
    ...
    def extract_cv_specific_metrics(self, paper: Paper) -> Dict[str, Any]:
        ...
        augmentation_terms = ["augment", "randaugment", "autoaugment", "cutmix", "mixup"]
...
class RLBenchmarkExtractor:
    ...
    def __init__(self):
        self.benchmark_environments = [
            "Atari", "MuJoCo", "OpenAI Gym", "Gym", "StarCraft",
            "Dota", "Go", "Chess", "Shogi", "Hex", "Hanabi",
            "DeepMind Control", "DMC", "Minecraft", "NetHack",
        ]
    ...
    def identify_benchmarks(self, paper: Paper) -> List[str]:
        ...
        for env in self.benchmark_environments:
            ...
            elif env == "DeepMind Control" and ("dmc" in text or "deepmind control" in text):
