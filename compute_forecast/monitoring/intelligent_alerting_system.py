...
class IntelligentAlertingSystem:
    ...
    def start(self) -> None:
        ...
        with self._lock:
            if not self._initialized:
                raise RuntimeError("Alerting system not initialized. Call initialize() first.")
    ...
    def send_test_alert(self, severity: str = "low", channels: Optional[List[str]] = None) -> Dict[str, bool]:
        """
    ...
    def get_system_status(self) -> Dict[str, Any]:
        ...
        with self._lock:
            status = {
                ...
                'notification_channels': list(self.alerting_engine.notification_channels.keys()),
                'alert_rules': {
                    rule_id: {
                        'name': rule.name,
    ...
    def _setup_default_channels(self) -> None:
        ...
        if self.enable_dashboard_alerts:
            ...
            self.alerting_engine.add_notification_channel("dashboard", dashboard_channel)
    ...
    def _setup_default_rules(self) -> None:
        ...
        try:
            ...
            for rule in default_rules:
                ...
                available_channels = list(self.alerting_engine.notification_channels.keys())
            ...
            while self._running:
                try:
                    ...
                    if current_metrics:
                        ...
                        triggered_alerts = self.alerting_engine.evaluate_alerts(metrics_dict)
...
def create_intelligent_alerting_system(config: Optional[Dict[str, Any]] = None) -> IntelligentAlertingSystem:
    """
