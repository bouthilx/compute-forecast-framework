...
from ...pipeline.metadata_collection.models import APIHealthStatus
...
class DashboardIntegration:
    ...
    def __init__(self, venue_engine=None, state_manager=None, data_processors=None):
        ...
        self.state_adapter = (
            StateManagerAdapter(state_manager) if state_manager else None
        )
...
class MockVenueEngine:
    ...
    def get_collection_progress(self) -> Dict[str, Any]:
        ...
        elapsed_minutes = (
            datetime.now() - self.mock_data["session_start"]
        ).total_seconds() / 60
...
class MockDataProcessors:
    ...
    def get_venue_normalizer_stats(self) -> Dict[str, Any]:
        return {"venues_normalized": 150, "accuracy": 0.96, "rate_per_second": 25.0}
