...
class NeurIPSCollector:
    ...
    def collect_neurips_by_year(
        self, year: int, max_papers: int = 50
    ) -> List[Dict[str, Any]]:
    ...
    def collect_multiple_years(
        self, start_year: int, end_year: int, papers_per_year: int = 50
...
def main():
    ...
    try:
        ...
        multi_year_results = collector.collect_multiple_years(
            start_year=2020, end_year=2023, papers_per_year=30
        )
