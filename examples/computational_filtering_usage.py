...
def example_basic_filtering():
    ...
    papers = [
        ...
        Paper(
            ...
            authors=[Author(name="Carol Johnson", affiliation="Philosophy Department")],
    ...
    for result in results:
        ...
        print(
            f"  Computational Richness: {result.computational_analysis.computational_richness:.2f}"
        )
...
def example_pipeline_integration():
    ...
    pipeline = setup_computational_filtering(
        api_layer=api_layer, monitoring_system=monitoring, filter_config=filter_config
    )
    ...
    test_papers = [
        Paper(
            ...
            authors=[
                Author(name=f"Author {i}", affiliation="MIT" if i % 2 else "Google")
            ],
            venue="NeurIPS" if i < 3 else "Workshop",
            year=2024,
            citations=i * 10,
            abstract="Neural network training with distributed systems."
            if i < 3
